...
public class InventoryScreen extends AbstractContainerScreen<InventoryMenu> {
    ...
    private static final ResourceLocation texture = new ResourceLocation("tech_revised:textures/gui/inventory.png");
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        guiGraphics.drawString(this.font, Component.translatable("gui.tech_revised.inventory.comp_controller"), 8, 9, -12829636, false);
    }
