...
public class HDD_27KB_Menu extends AbstractContainerMenu {
    public final HDD_27KB_BlockEntity blockEntity;
    ...
    public HDD_27KB_Menu(int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler  -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler , 18, 8, 44));
            this.addSlot(new SlotItemHandler(iItemHandler , 19, 26, 44));
            this.addSlot(new SlotItemHandler(iItemHandler , 20, 44, 44));
            this.addSlot(new SlotItemHandler(iItemHandler , 21, 62, 44));
            this.addSlot(new SlotItemHandler(iItemHandler , 22, 80, 44));
            this.addSlot(new SlotItemHandler(iItemHandler , 23, 98, 44));
            this.addSlot(new SlotItemHandler(iItemHandler , 24, 116, 44));
            this.addSlot(new SlotItemHandler(iItemHandler , 25, 134, 44));
            this.addSlot(new SlotItemHandler(iItemHandler , 26, 152, 44));
        });
    }
